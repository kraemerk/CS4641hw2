...
fit.train()
print "RHC Negative of Distance: " + str(ef.value(rhc.getOptimal()))
print "Route:"
path = []
for x in range(0,N):
...
fit.train()
print "SA Negative of Distance: " + str(ef.value(sa.getOptimal()))
print "Route:"
path = []
for x in range(0,N):
...
fit.train()
print "GA Negative of Distance: " + str(ef.value(ga.getOptimal()))
print "Route:"
path = []
for x in range(0,N):
...
fit = FixedIterationTrainer(mimic, 200000)
fit.train()
